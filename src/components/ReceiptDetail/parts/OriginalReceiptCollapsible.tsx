...
export function OriginalReceiptCollapsible({
  ...
  // Four mutually exclusive viewers, most specific first. Early returns
  // rather than a ternary chain: each branch keeps its own "why" comment
  // next to the element it explains.
  const renderBody = () => {
    if (isEmail) {
      return (
